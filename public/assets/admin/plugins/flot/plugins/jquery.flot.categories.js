...
generated mapping where the first category_title becomes 0, the second 1, etc.
Hence, a point like ["February", 34] becomes [0, 34] internally in Flot (this
is visible in hover and click events that return numbers rather than the
category_title labels). The plugin also overrides the tick generator to spit out the
