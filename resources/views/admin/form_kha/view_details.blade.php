                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="page-title text-center">ইউনিয়ন পরিষদ বাজেট ফরম "খ"</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td style="text-align: center; color: red" colspan="5">No Data Found!
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
                                ...
                                @if (!empty($partOneRevenueIncomeAccountList))
                                    <table class="table table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                <th style="width: 25%" class="text-center">প্রাপ্তির
                                                    বিবরণ</th>
                                                <th style="width: 15%;" class="text-center">
                                                    নোট</th>
                                                <th style="width: 12%" class="text-center">পূর্ববর্তী
                                                    বৎসরের প্রকৃত আয়
                                                    (২০২০-২০২১)</th>
                                                <th style="width: 12%" class="text-center">চলতি বৎসরের
                                                    বাজেট বা
                                                    সংশোধিত
                                                    বাজেট (২০২১-২০২২)
                                                </th>
                                                <th style="width: 12%" class="text-center">প্রকৃত আয়
                                                    (২০২০-২০২১)
                                                </th>
                                                <th style="width: 12%" class="text-center">পরবর্তী
                                                    বৎসরের বাজেট
                                                    (২০২২-২০২৩)</th>
                                                <th style="width: 12%" class="text-center">প্রকৃত আয়
                                                    (২০২২-২০২৩)</th>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th colspan="7" style="background-color: #ebebeb">
                                                        {{ $partOneRevenueIncomeAccount->category_name }}
                                                    </th>
                                                </tr>
                                            </thead>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @foreach ($partOneRevenueExpenditureAccountList as $partOneRevenueExpenditureAccount)
                                            <thead>
                                                <tr>
                                                    <th colspan="7" style="background-color: #ebebeb">
                                                        {{ $partOneRevenueExpenditureAccount->category_name }}
                                                    </th>
                                                </tr>
                                            </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    @if ($partOneIncomeAccountSubcategory->last_year_budget ||
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 25%">
                                                                {{ $partOneIncomeAccountSubcategory->subcategory_name }}
                                                            </td>
                                                            <td style="width: 15%">
                                                                {{ $partOneIncomeAccountSubcategory->notes }}
                                                            </td>
                                ...
                                @if (!empty($partTwoDevRevenueExpenditureAccountList))
                                    <table class="table table-bordered">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th style="background-color: #ebebeb; width: 25%">
                                                        {{ $partTwoDevRevenueExpenditureAccount->category_name }}
                                                    </th>
                                                    <th style="background-color: #ebebeb; width: 15%">
                                                    </th>
                                                    <th style="background-color: #ebebeb; width: 12%">
                                                    </th>
                                                    <th style="background-color: #ebebeb; width: 12%">
                                                    </th>
                                                    <th style="background-color: #ebebeb; width: 12%">
                                                ...
                                                @foreach ($partTwoDevExpAccountSubcategoryList as $partTwoDevExpAccountSubcategory)
                                                    @if ($partTwoDevExpAccountSubcategory->last_year_budget ||
                                                        ...
                                                        <tr>
                                                            ...
                                                            @endphp
                                                            <td style="width: 25%">
                                                                {{ $partTwoDevExpAccountSubcategory->subcategory_name }}
                                                            </td>
                                                            <td style="width: 15%">
                                                                {{ $partTwoDevExpAccountSubcategory->notes }}
                                                            </td>
                                                            <td style="text-align: end; width: 12%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="7" style="background-color: #44546a">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            <td style="background-color: #c6e0b4; width: 25%">রাজস্ব আয়
                                            </td>
                                        ...
                                        <tr>
                                            <td style="background-color: #ffc000; width: 25%">রাজস্ব
                                                উদ্বৃত্ত</td>
                                        ...
                                        <tr>
                                            <td style="background-color: #c6e0b4; width: 25%">মোট
                                                রাজস্ব ব্যয়</td>
                                            <td style="background-color: #c6e0b4; width: 15%"></td>
                                            <td style="background-color: #c6e0b4; width: 12%; text-align: end">
                                        ...
                                        <tr>
                                            <td style="background-color: #f4b084; width: 25%">মোট
                                                উন্নয়ন আয়= উপমোট উন্নয়ন আয়+
                                                রাজস্ব উদ্বৃত্ত</td>
                                        ...
                                        <tr>
                                            <td style="background-color: #acb9ca; width: 25%">মোট আয়
                                                (রাজস্ব আয়+উপমোট উন্নয়ন
                                                আয়)</td>
                                            <td style="background-color: #acb9ca; width: 15%"></td>
                                            <td style="background-color: #acb9ca; width: 12%; text-align: end">
                                                {{ $last_year_total_amount + $p_two_exp_last_year_total_amount }}
                                            </td>
                                            <td style="background-color: #acb9ca; width: 12%; text-align: end">
                                                {{ $current_year_total_amount + $p_two_exp_current_year_total_amount }}
                                            </td>
                                            <td style="background-color: #acb9ca; width: 12%; text-align: end">
                                                {{ $current_year_actual_income_total_amount + $p_two_exp_current_year_actual_income_total_amount }}
                                            </td>
                                            <td style="background-color: #acb9ca; width: 12%; text-align: end">
                                                {{ $next_year_total_amount + $p_two_exp_next_year_total_amount }}
                                            </td>
                                            <td style="background-color: #acb9ca; width: 12%; text-align: end">
                                        ...
                                        <tr>
                                            <td style="width: 25%">সমাপ্তি জের = (মোট উন্নয়ন আয়-উপমোট
                                                উন্নয়ন ব্যয়)</td>
                                            <td style="width: 15%"></td>
                                            <td style="width: 12%; text-align: end">
                                        ...
                                        <tr>
                                            <td style="background-color: #acb9ca; width: 25%">মোট ব্যয়
                                                (সমাপ্তি জের সহ)</td>
                                            <td style="background-color: #acb9ca; width: 15%"></td>
