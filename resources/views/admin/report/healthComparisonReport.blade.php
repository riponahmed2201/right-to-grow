                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.healthComparisonReport') }}" class="btn btn-success">Reset</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row" id="bar_chart_data">
                <div class="col-12">
                    <div class="card">
                        ...
                        @if (!$output_array)
                            <strong class="text-danger" style="text-align: center; margin-top: 20px; margin-bottom: 20px;">No Data Found!</strong>
                        @else
                            <div class="card-body">
