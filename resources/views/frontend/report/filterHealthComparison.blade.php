            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{ route('user.getHealthComparisonTracking') }}" method="GET">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required id="from_financial_year"
                                                class="form-control mt-2 select2bs4 @error('from_financial_year') is-invalid @enderror"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required id="to_financial_year"
                                                class="form-control mt-2 select2bs4 @error('to_financial_year') is-invalid @enderror"
